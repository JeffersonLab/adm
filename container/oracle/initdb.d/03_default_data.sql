...
-- Results
insert into adm_owner.remote_command_result(remote_command_result_id, env_id, exit_code, out, err, stack_trace, job_start, job_end) values (adm_owner.remote_command_result_id.nextval, 1, 0, null, null, null, sysdate, sysdate + 1);